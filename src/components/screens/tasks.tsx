...
export function TasksScreen() {
  ...
  if (!activeHouse) {
    return (
      <div className="flex flex-col" style={{ background: 'var(--ios-bg)', height: '100vh' }}>
        <div className="shrink-0 px-4 pb-2" style={{ paddingTop: 'max(68px, env(safe-area-inset-top, 68px))' }}>
  ...
  return (
    <div className="flex flex-col" style={{ background: 'var(--ios-bg)', height: '100vh', overflow: 'hidden' }}>
      {/* Header */}
      <div className="shrink-0 px-4 pt-[60px] pb-2" style={{ paddingTop: 'max(68px, env(safe-area-inset-top, 68px))' }}>
